...
- Cervanttis voice lines are their own block: lowercase, human, an aside.
- Emphasis on a markdown display token (headline/lede/quote) is the rare *turn word* only: wrap it in
  _underscores_ to set it in the Cervanttis italic display face. Use at most ~3 across a deck — never on
  every slide, never a whole line. (Asterisks *word* are a legacy roman accent; prefer _word_.)
