...
- Cervanttis voice lines are their own block: lowercase, human, an aside — never inline italic.
...
- carousel-journal posts follow cover → intro → interior → closing; each interior has exactly
  three label/quote sections.
...
module.exports = { generateCampaign, schemaDigest, foldTokenPairs, hasKey, OUTPUT_SCHEMA, SYSTEM_RULES, MODEL };
