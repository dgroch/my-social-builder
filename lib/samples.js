...
const SAMPLE_TOKENS = {
  ...
  'carousel-journal/statement': {
    ...
    headline: 'Watch the florists I admire, and the first thing you see *isn’t* the flowers.',
