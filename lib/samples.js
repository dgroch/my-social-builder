...
const TRYON_SLOTS = [
  ['card-caption', 'cover',         { photo: 'photo', main: 'caption', case: 'lower' }],
  ['card-statement-bars', 'cover',  { photo: 'photo', main: 'headline', case: 'lower' }],
  ['card-statement-split', 'cover', { photo: 'photo', main: 'headline', case: 'lower' }],
  ['card-script-moment', 'cover',   { photo: 'photo', main: 'line', case: 'lower', apply: { surface: 'photo' } }],
